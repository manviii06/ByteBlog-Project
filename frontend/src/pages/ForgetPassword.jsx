...
const ForgetPassword = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 min-h-screen flex justify-center items-center p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {!otpSent ? (
            <button
              ...
              className="mt-6 w-full bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 hover:bg-gradient-to-l hover:from-indigo-600 hover:via-purple-500 hover:to-pink-500 
            transition-colors duration-200 cursor-pointer text-white py-2 px-4 rounded-2xl"
            >
              Send OTP
            </button>
          ) : (
